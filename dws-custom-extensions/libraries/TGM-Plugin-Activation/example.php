 ...
 * @subpackage Example
 * @version    2.6.1 for plugin DWS WordPress Core
...
add_action( 'tgmpa_register', 'DWS_CUSTOM_EXTENSIONS_LANG_DOMAIN_register_required_plugins' );
 ...
 */
function DWS_CUSTOM_EXTENSIONS_LANG_DOMAIN_register_required_plugins() {
	/*
