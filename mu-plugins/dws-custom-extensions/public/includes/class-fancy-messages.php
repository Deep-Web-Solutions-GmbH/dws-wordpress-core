...
final class DWS_FancyMessages extends DWS_Functionality_Template {
	 ...
	 * @version 1.0.0
	 *
	 * @var     string  MESSAGES_OVERWRITE_PLUGINS      The name of the ACF options field that determines whether the stylesheet
	 *                                                  for fancy messages will be loaded or not.
	 */
	...
	protected function functionality_options() {
		return array_merge(
			...
			call_user_func_array('array_merge', array_map(
	...
	public function enqueue_assets() {
		...
		$css = DWS_Helper::get_stylesheet_with_variables(DWS_Public::get_assets_base_path() . 'fancy-messages.css',
			array(
